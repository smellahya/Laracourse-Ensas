<div class="bg-blue-700 px-4 sm:px-6 py-3 flex items-center justify-between shadow h-16 fixed top-0 left-0 right-0 z-50">
    <div class="flex items-center text-white">
        <img src="images/ensasafi.couleur-206x206.png" width="60" height="20" alt="Image" class="img-fluid">
        <span class="font-semibold text-sm sm:text-xl tracking-tight">ENSAS PLATEFORM</span>
    </div>
    <div class="relative">
        @auth
