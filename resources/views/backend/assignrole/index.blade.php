    ...
    <div class="roles-permissions">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="{{ route('assignrole.create') }}" class="bg-gray-0 text-gray-700 text-sm uppercase py-2 px-4 flex items-center rounded">
                   <button class="btn btn-outline-success"
                    <span class="ml-2 text-xs font-semibold">Add User</span>
                </a>
            </div>
        </div>
