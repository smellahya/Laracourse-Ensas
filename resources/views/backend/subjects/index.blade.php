    ...
    <div class="roles-permissions">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="items-center">
                <a href="{{ route('subject.create') }}" class="bg-gray-0 text-gray-700 text-sm uppercase py-2 px-4 flex items-center rounded">
                    <button class="btn btn-outline-success">
                    <span class="ml-2 text-xs font-semibold">Add Subject</span>
                </button>
                </a>
            </div>
        </div>
