    ...
    <div class="create">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="{{ route('home') }}" class="bg-gray-00 text-gray-700 text-sm uppercase py-2 px-4 flex items-center rounded">
                    <button class="btn btn-primary"><span class="ml-2 text-xs font-semibold">Back</span></button>
                </a>
            </div>
        </div>
