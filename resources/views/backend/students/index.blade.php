    ...
    <div class="roles-permissions">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="{{ route('student.create') }}" class="bg-gray-000 text-gray-700 text-sm uppercase py-2 px-4 flex items-center rounded">
                    <button class="btn btn-outline-success">
                        <span class="ml-2 text-xs font-semibold">Add Student</span></button>
                </a>
            </div>
        </div>
            ...
            @foreach ($students as $student)
                <div class="flex flex-wrap items-center text-gray-700 border-t-2 border-l-4 border-r-4 border-gray-300">
                    ...
                    <div class="w-2/12 flex items-center justify-end px-3">
                        <a href="{{ route('student.show',$student->id) }}" class="ml-1 bg-gray-0 block p-1" title="assign subject">
