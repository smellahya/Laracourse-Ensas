    ...
    <div class="roles-permissions">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex flex-wrap items-center">
                <a href="{{ route('role.create') }}" class="bg-gray-00 text-gray-700 text-sm uppercase py-2 px-4 mr-2 flex items-center rounded">
                    
                    <button class="btn btn-success"><span class="ml-2 text-xs font-semibold">Add Role</span></button>
                </a>
                <a href="{{ route('permission.create') }}" class="bg-gray-00 text-gray-700 text-sm uppercase py-2 px-4 flex items-center rounded">
                    <button class="btn btn-primary">
                    <span class="ml-2 text-xs font-semibold">Add Permission</span>
                    </button>
                </a>
            </div>
        </div>
